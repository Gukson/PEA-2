...
public:
    void statsOutput(vector<double> stats, vector<double> timeMeasurements, vector<double> absolutes, vector<double> relatives, vector<int> best_way, int wynik, bool show, int bestWynik, string filename );
